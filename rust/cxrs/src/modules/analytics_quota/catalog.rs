...
fn embedded_quota_catalog() -> Value {
    ...
    json!({
        ...
        "entries": [
            ...
            { "provider":"llama.cpp", "backend":"llamacpp", "tier":"local", "service_kind":"local_unmetered", "limit_type":"unmetered", "quota_total_tokens": null, "window_days": null, "source_url":"https://github.com/ggml-org/llama.cpp", "retrieved_at": now, "notes":"Local llama.cpp inference via llama-cli; no provider-enforced quota." },
            { "provider":"mlx", "backend":"mlx", "tier":"local", "service_kind":"local_unmetered", "limit_type":"unmetered", "quota_total_tokens": null, "window_days": null, "source_url":"https://github.com/ml-explore/mlx-lm", "retrieved_at": now, "notes":"Local Apple MLX inference via mlx-lm; no provider-enforced quota." }
        ]
    })
}
